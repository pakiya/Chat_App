package singh.pk.chatappdemo.main.profile_setting;
...
import singh.pk.chatappdemo.main.profile_setting.status_change.StatusActivity;

/**Shows and Manages User profile settings.
 * @author Pankaj*/
public class SettingsActivity extends AppCompatActivity {
    ...
    Button mStatusBtn;
    @BindView(R.id.settings_image_btn) Button mImageBtn;
